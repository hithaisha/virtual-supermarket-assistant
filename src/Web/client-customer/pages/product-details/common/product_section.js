              ...
              <Row>
                <Col lg="6" xs="12">
                  <div className="quick-view-img">
                    <Media
                      src={`${selectedProduct?.itemImageUrl}`}
                      alt=""
                      className="img-fluid"
                    />
                  </div>
                  ...
                  <div className="product-right">
                    ...
                    {selectedProduct.variants ? (
                      <ul className="color-variant">
                        {uniqueTags ? (
                          <ul className="color-variant">
                            {selectedProduct?.categoryName === 'jewellery' ||
                            selectedProduct?.categoryName === 'nursery' ||
                            selectedProduct?.categoryName === 'beauty' ||
                            selectedProduct?.categoryName === 'electronics' ||
                            selectedProduct?.categoryName === 'goggles' ||
                            selectedProduct?.categoryName === 'watch' ||
                            selectedProduct?.categoryName === 'pets' ? (
                              ''
                            ) : (
                              <>
                                {uniqueTags ? (
