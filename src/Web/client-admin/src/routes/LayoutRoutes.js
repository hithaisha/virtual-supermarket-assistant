...
import List_item from '../components/items/list-items'
import Create_item from '../components/items/create-item'
    ...
    <Fragment>
        <Routes>
            ...
            <Route
						...
						<Route
							path={`${process.env.PUBLIC_URL}/items/list-item`}
							element={<List_item />}
						/>
						<Route
							path={`${process.env.PUBLIC_URL}/items/item-settings/:id`}
							element={<Create_item />}
						/>
